...
import Youtube from '../images/youtube-offer.png'

import Testimonials from '../images/testimonials/image 9.png'
...
const initialState = {
    ...
    offer: [
        {youtube: true, iconYoutube:Youtube, icon: Camera, title: 'Modern Photo and Video', description: 'We offer high-quality video and photo in order  to capture every detail of your  perfect wedding day.'},
